...
from adcp.types.legacy import LegacyGetProductsRequest as GeneratedGetProductsRequest
from adcp.types.legacy import LegacyGetProductsResponse as GeneratedGetProductsResponse
