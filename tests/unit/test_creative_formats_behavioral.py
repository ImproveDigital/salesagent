...
# adcp 6.4: Assets classes are type-discriminated by asset_type + item_type.
# Assets = individual image, Assets25 = individual video
# Assets39 = repeatable_group (has nested assets, no asset_type)
# Nested group assets: Assets41 (image), Assets42 (video), Assets44 (text), etc.
...
class TestAssetTypesFilterChecksGroupAssets:
    ...
    def test_asset_types_filter_finds_type_in_group_assets(self):
        ...
        # adcp 6.4: repeatable_group uses Assets39, nested items use Assets41+ variants
        from adcp.types.generated_poc.core.format import Assets39, Assets41, Assets44

        group_asset = Assets39(
    ...
    def test_asset_types_filter_excludes_group_without_match(self):
        ...
        # adcp 6.4: repeatable_group uses Assets39, nested text items use Assets44
        from adcp.types.generated_poc.core.format import Assets39, Assets44
    ...
    def test_asset_types_filter_mixed_individual_and_group(self):
        ...
        # adcp 6.4: Assets25 = individual video, Assets39 = repeatable_group
        # Assets39 nested assets use Assets41+ classes (image=Assets41)
        from adcp.types.generated_poc.core.format import Assets39, Assets41

        individual_asset = Assets25(
            asset_id="hero_video",
            required=True,
        )
        group_asset = Assets39(
...
class TestAssetTypesFilterExclusion:
    ...
    def test_format_with_non_matching_assets_excluded(self):
        ...
        # adcp 6.4: use typed asset classes - Assets (image), Assets29 (html)
        from adcp.types.generated_poc.core.format import Assets29
    ...
    def test_format_with_assets_of_wrong_type_excluded_while_match_kept(self):
        ...
        # adcp 6.4: Assets (image), Assets25 (video)
        formats = [
            _make_format(
                "image_only",
                "Image Only",
