...
def _stat(line_item_id="202", campaign_id="314403", impressions=1000, clicks=10, completed=None, micros=4_000_000):
...
class TestReportingPayload:
    def test_rows_join_media_buys_and_convert_micros(self):
        payload = _improvedigital_reporting_payload([_stat()], {"314403": _buy()}, "EUR")
