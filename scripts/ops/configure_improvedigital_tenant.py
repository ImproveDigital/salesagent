...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        required=True,
        help="Buying entity ID (discover via the adapter settings' Test Connection)",
    )
    parser.add_argument("--buying-entity-office-id", type=int, default=None, help="Buying entity office (buyer seat)")
    parser.add_argument(
        "--business-unit-id",
        type=int,
        required=True,
        help="Business unit ID for Classic line items (ask the Improve Digital team for your value)",
    )
    parser.add_argument(
        "--buyer-id",
        type=int,
